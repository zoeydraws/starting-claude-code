...
Yes! Use `/rewind` (or press `Escape` twice) to open a menu where you can:

- Rewind conversation only (keep code changes)
- Revert code only (keep conversation)
- Revert both code and conversation
