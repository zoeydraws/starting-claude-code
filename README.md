...
| [5_SHORTCUTS.md](5_SHORTCUTS.md)                     | Shortcuts and slash commands                      |
| [6_SKILLS.md](6_SKILLS.md)                           | Auto-triggered patterns (more advanced)           |

## Templates

The `templates/` folder contains starter files you can copy into your own setup:

- **STARTER_GLOBAL_CLAUDE.md** — Personal preferences that apply to all projects
- **STARTER_PROJECT_CLAUDE.md** — Project-specific instructions template
- **SESSION_LOG_TEMPLATE.md** — Track your work across sessions
